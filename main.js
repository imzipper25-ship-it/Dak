...
const translations = {
    pt: {
        ...
        hero_tag: "✦ ENGENHARIA CIVIL",
        hero_title: "CONSTRUÇÃO CIVIL A CUSTO REAL",
        hero_subtitle: "Direção de obra sem margens ocultas. Materiais a preço de custo e equipa à jorna.",
        hero_cta: "Solicitar Estimativa Grátis",
        hero_secondary: "Como funciona o modelo à jorna?",
        card_transparent_title: "Preço de Custo",
        card_transparent_sub: "Faturação direta de fornecedores",
        card_team_title: "Direção Técnica",
        card_team_sub: "Engenheiros certificados pela OE",
    ...
    en: {
        ...
        hero_tag: "✦ CIVIL ENGINEERING",
        hero_title: "CONSTRUCTION AT REAL COST",
        hero_subtitle: "Open-book project management. Materials at trade cost and day-rate labor.",
        hero_cta: "Request Free Cost Estimate",
        hero_secondary: "How does our day-rate model work?",
        card_transparent_title: "At-Cost Billing",
        card_transparent_sub: "Direct supplier invoices",
        card_team_title: "Technical Direction",
        card_team_sub: "Licensed structural engineers",
    ...
    ru: {
        ...
        hero_tag: "✦ СТРОИТЕЛЬНАЯ ИНЖЕНЕРИЯ",
        hero_title: "СТРОИТЕЛЬСТВО ПО СЕБЕСТОИМОСТИ",
        hero_subtitle: "Технический надзор без переплат. Материалы по оптовым ценам, рабочие — посменно.",
        hero_cta: "Рассчитать смету бесплатно",
        hero_secondary: "Как работает посменная оплата (à jorna)?",
        card_transparent_title: "Себестоимость",
        card_transparent_sub: "Счета от поставщиков напрямую",
        card_team_title: "Технический надзор",
        card_team_sub: "Сертифицированные инженеры",
